...
static char const * const pace_event_type_to_string[] = {
    ...
    IPQ_ENUM_TO_STRING(PACE2_ADVANCED_SOCKS_EVENT),
    ...
    IPQ_ENUM_TO_STRING(PACE2_ADVANCED_TELNET_EVENT),
    IPQ_ENUM_TO_STRING(PACE2_ADVANCED_MMSE_EVENT),
    IPQ_ENUM_TO_STRING(PACE2_ADVANCED_L2TP_EVENT),
